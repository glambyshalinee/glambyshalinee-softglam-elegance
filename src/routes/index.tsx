...
import {
  Sparkles, Crown, Heart, Star, Diamond, Brush, Scissors, Hand,
  Award, ShieldCheck, Clock, Wand2, UserCheck, Leaf, Users, MapPin,
  Instagram, ChevronDown, ArrowRight, Calendar, Phone, Mail, Quote,
} from "lucide-react";
  ...
  return (
    <section id="top" className="relative min-h-[100svh] overflow-hidden bg-gradient-soft">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-[12%] top-[40%] h-3 w-3 rounded-full bg-[color:var(--rose-gold)] opacity-60 animate-float" style={{ animationDelay: "1.2s" }} />
        <div className="absolute left-[18%] bottom-[22%] h-1.5 w-1.5 rounded-full bg-[color:var(--champagne)] animate-float" style={{ animationDelay: "2.4s" }} />
        <Sparkles className="absolute right-[18%] top-[18%] h-6 w-6 text-[color:var(--champagne)] opacity-70 animate-float" style={{ animationDelay: "0.6s" }} />
      </div>
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-center px-6 pb-24 pt-32">
        <div className="max-w-2xl">
          ...
          <p className="mt-8 max-w-xl font-serif-luxe text-xl leading-relaxed text-foreground/70 md:text-2xl animate-fade-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="mt-16 flex flex-wrap items-center gap-8 animate-fade-up" style={{ animationDelay: "0.6s" }}>
            {[
      ...
      <div className="relative mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:gap-24">
        <div className="scroll-reveal relative">
          ...
          <div className="image-zoom relative aspect-[3/4] overflow-hidden rounded-[2rem] shadow-luxe">
            <img src={artist} alt="Portrait of bridal makeup artist" className="h-full w-full object-cover" loading="lazy" width={1024} height={1280} />
          </div>
        ...
        <div className="scroll-reveal flex flex-col justify-center">
          ...
          <h2 className="mt-4 font-display text-4xl leading-[1.1] md:text-6xl">
            A craft of <em className="font-serif-luxe italic text-gradient-gold">light, skin</em><br />
            and quiet luxury.
          </h2>
          <p className="mt-8 font-serif-luxe text-xl leading-relaxed text-foreground/75">
            For over a decade, Aanya has shaped the face of modern bridal beauty — blending
            heritage techniques with the polish of international fashion houses. Her work has
            graced editorial covers, runways, and the most intimate of weddings.
          </p>
          ...
          <div className="mt-12 font-script text-5xl text-[color:var(--rose-gold)]">
            Shalinee
          </div>
...
/* ---------------- SERVICES ---------------- */
const services = [
  { icon: Crown, name: "Basic Bridal", price: "₹5,000 – ₹10,000", desc: "Signature heirloom bridal artistry for the most cherished day." },
  { icon: Sparkles, name: "HD Makeup", price: "₹4,500 – ₹8,000", desc: "Camera-ready finish that lives flawlessly on every screen." },
  { icon: Wand2, name: "Airbrush Makeup", price: "₹10,000 – ₹15,000", desc: "Weightless coverage with a luminous, second-skin glow." },
  { icon: Heart, name: "Engagement / Reception", price: "₹5,000 – ₹8,000", desc: "Soft romantic glam that captures the moment forever." },
  { icon: Star, name: "Party / Occasion Makeup", price: "₹1,500 – ₹3,500", desc: "Effortless polish for celebrations big and small." },
  { icon: Scissors, name: "Hairstyling", price: "₹600 – ₹1,000", desc: "Sculptural updos, soft waves and contemporary chignons. Advanced styling at ₹2,000+" },
  { icon: Hand, name: "Draping (Saree/Dupatta)", price: "₹300 – ₹600", desc: "Couture saree & dupatta draping with architectural finesse." },
  { icon: Leaf, name: "Nail Extensions", price: "Coming soon", desc: "Hand-finished nail art and luxe extensions — launching soon." },
];

function Services() {
  return (
    <section id="services" className="relative overflow-hidden bg-[color:var(--ivory)] py-28 md:py-40">
      <div className="mx-auto max-w-7xl px-6">
        <div className="scroll-reveal mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 font-display text-4xl md:text-6xl">
            Couture beauty, <em className="font-serif-luxe italic text-gradient-gold">curated</em> for you
          </h2>
          <p className="mt-6 font-serif-luxe text-lg text-foreground/70">
            Each experience is bespoke — a meticulous blend of skin prep, technique and storytelling.
          </p>
        </div>
...
const categories = ["All", "Bridal", "Soft Glam", "Editorial", "Engagement", "Reception", "Party Looks"];
  ...
  return (
    <section id="portfolio" className="relative bg-gradient-soft py-28 md:py-40">
      ...
      {lightbox && (
        ...
        >
          <img src={lightbox} alt="Look" className="max-h-[90vh] max-w-full rounded-2xl shadow-luxe" />
        </div>
      )}
    </section>
  );
...
function Transform() {
  ...
  return (
    <section id="transform" className="relative overflow-hidden bg-[color:var(--ivory)] py-28 md:py-40">
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          <img src={afterImg} alt="After bridal makeup" className="absolute inset-0 h-full w-full object-cover" loading="lazy" width={1024} height={1280} />
...
/* ---------------- TESTIMONIALS ---------------- */
const reviews = [
  { name: "Ishita & Rohan", role: "Bride · Udaipur Wedding", text: "Aanya didn't just do my makeup — she translated my entire wedding vision into a feeling. My grandmother cried.", rating: 5 },
  { name: "Priya Kapoor", role: "Vogue Cover", text: "An unmatched eye for light and skin. Working with her is like collaborating with a master painter.", rating: 5 },
  { name: "Meera Shah", role: "Reception · Mumbai", text: "Everyone asked who did my face. Twelve hours of dancing and the glow stayed exactly the same.", rating: 5 },
  { name: "Tanvi & Family", role: "Destination Bride · Goa", text: "Calm, kind, and a complete artist. She made the most stressful morning feel like a spa.", rating: 5 },
];
...
function Testimonials() {
  ...
  return (
    <section id="reviews" className="relative bg-gradient-dark py-28 text-[color:var(--ivory)] md:py-40">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
          {igPosts.map((src, i) => (
            ...
            >
              <img src={src} alt="Instagram reel" className="h-full w-full object-cover transition duration-700 group-hover:scale-110" loading="lazy" width={600} height={600} />
...
function Booking() {
  return (
    <section id="booking" className="relative overflow-hidden bg-[color:var(--ivory)] py-28 md:py-40">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-6 lg:grid-cols-2">
        <div className="scroll-reveal">
          ...
          <div className="mt-10 space-y-4">
            <a href="tel:+919340590475" className="flex items-center gap-4 text-foreground/80 hover:text-[color:var(--rose-gold)] transition">
              <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-luxe text-[color:var(--ivory)]"><Phone className="h-4 w-4" /></span>
              <span className="font-serif-luxe text-lg">+91 93405 90475</span>
            </a>
            <a href="mailto:glambyshalinee@gmail.com" className="flex items-center gap-4 text-foreground/80 hover:text-[color:var(--rose-gold)] transition">
              <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-luxe text-[color:var(--ivory)]"><Mail className="h-4 w-4" /></span>
              <span className="font-serif-luxe text-lg">glambyshalinee@gmail.com</span>
            </a>
            <div className="flex items-center gap-4 text-foreground/80">
              <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-luxe text-[color:var(--ivory)]"><MapPin className="h-4 w-4" /></span>
...
function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-[2rem] glass p-8 shadow-soft-luxe md:p-10 in-view">
...
function Field({ label, icon, ...rest }: React.InputHTMLAttributes<HTMLInputElement> & { label: string; icon?: React.ReactNode }) {
  return (
    <div>
      ...
      <div className="relative">
        {icon && <span className="absolute right-5 top-1/2 -translate-y-1/2 text-[color:var(--rose-gold)]">{icon}</span>}
        <input {...rest} className="w-full rounded-full border border-[color:var(--border)] bg-[color:var(--ivory)]/60 px-5 py-3.5 text-sm outline-none transition focus:border-[color:var(--rose-gold)]" />
      </div>
    </div>
  );
}
...
/* ---------------- FAQ ---------------- */
const faqs = [
  { q: "How far in advance should I book my bridal trial?", a: "We recommend booking 3–6 months in advance for peak wedding season. A trial is scheduled 2–4 weeks before the event." },
  { q: "Do you travel for destination weddings?", a: "Absolutely. We've travelled to 12+ countries. Travel and accommodation are billed at actuals." },
  { q: "Are products skin-friendly and hygienic?", a: "Yes — we use pro-grade hypoallergenic products, single-use applicators, and follow strict sanitisation between every client." },
  { q: "Do you offer packages for the entire bridal party?", a: "Yes, custom family packages can be tailored to include mother, sisters, and bridesmaids." },
  { q: "How long does a bridal session take?", a: "A complete bridal look (makeup + hair + draping) typically takes 2.5 to 3 hours of unhurried artistry." },
];
    ...
    <section className="bg-gradient-soft py-28 md:py-40">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-16 space-y-3">
          {faqs.map((f, i) => (
            <div key={i} className="scroll-reveal overflow-hidden rounded-2xl border border-[color:var(--border)] bg-card">
              <button onClick={() => setOpen(open === i ? null : i)} className="flex w-full items-center justify-between gap-6 px-6 py-5 text-left">
    ...
    <footer className="relative overflow-hidden bg-gradient-dark py-20 text-[color:var(--ivory)]">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 md:grid-cols-4">
        <div className="md:col-span-2">
          <img src={logoImg} alt="glambyshalinee logo" className="h-20 w-20 rounded-full object-cover shadow-soft-luxe" />
        ...
        <div>
          <div className="font-sans-luxe text-[10px] uppercase tracking-[0.3em] text-[color:var(--champagne)]">Explore</div>
          <ul className="mt-4 space-y-2 text-sm text-[color:var(--ivory)]/70">
            {["About", "Services", "Portfolio", "Reviews", "Booking"].map((l) => (
              <li key={l}><a href={`#${l.toLowerCase()}`} className="hover:text-[color:var(--champagne)]">{l}</a></li>
            ))}
          </ul>
        </div>

        <div>
          <div className="font-sans-luxe text-[10px] uppercase tracking-[0.3em] text-[color:var(--champagne)]">Studio</div>
          <ul className="mt-4 space-y-2 text-sm text-[color:var(--ivory)]/70">
      ...
      <div className="mx-auto mt-16 max-w-7xl border-t border-[color:var(--ivory)]/10 px-6 pt-8 text-center text-xs text-[color:var(--ivory)]/50">
        ...
        <div className="mt-4 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <span className="font-serif-luxe italic text-[color:var(--ivory)]/60">
            Website designed and developed by <span className="text-[color:var(--champagne)]">DIVY SONI</span>
          </span>
          <a
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Glam by Shalinee — award-winning bridal and fashion makeup artist creating timeless soft glam luxury for brides and editorials worldwide." },
      { property: "og:title", content: "glambyshalinee — Luxury Bridal & Fashion Makeup Artist" },
      { property: "og:description", content: "Soft glam luxury meets modern bridal elegance. Book a couture beauty experience." },
